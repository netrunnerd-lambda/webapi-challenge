...
Middleware handles different aspects of an application through functions that can perform tasks like authentication, body validation, error handling, logging and so on.
...
200, an HTTP status code that indicates the success of a request as defined by the standard.
